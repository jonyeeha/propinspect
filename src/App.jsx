...
const loadDB = () => { try { const r = localStorage.getItem(STORE_KEY); return r ? JSON.parse(r) : null; } catcimport { useState, useCallback, useRef } from "react";
      ...
      if(rptMode==="wo"){
        ...
        selWOs.forEach((wo,idx)=>{
          ...
          const details=[
            ...
            ["Phone",ct?.phone||"—"],["Created",wo.createdAt],
            ["Accepted",wo.acceptedAt||"Not yet"],["Completed",wo.completedAt||"Not yet"],
          ];
          const cw2=CW/2-4;
...
const CHECKLIST_TEMPLATE = [
  ...
  { area: "Signs (stop, handicap, fire lane)", items: ["Condition", "Compliance", "Installation"] },
  { area: "Lighting (night inspection)", items: ["Parking Lot", "Back of House security lighting", "Common area sidewalk lighting", "Canopy/Sconce"] },
  { area: "Landscaping", items: ["Condition",import { useState, useCallback, useRef } from "react";
